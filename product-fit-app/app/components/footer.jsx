...
const Footer = () => {
    return (
        <footer className="flex vs:flex-col w-full vs:bg-gray-100 ts:bg-[#F9FBFE] vs:justify-center vs:items-center vs:mt-[0px] ts:mt-[0px] vs:h-[403px] ts:h-[242px] ts:pl-[60px] ts:pr-[60px] ns:p-0 vs:pb-[30px]" >
