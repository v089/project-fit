...
const Orders = () => {
    return (
        <div className='w-full vs:flex items-center justify-center ts:mt-[105px] vs:mt-[90px] z-10'>
            ...
            <div className="ts:grid vs:hidden ns:grid-cols-[repeat(4,_248px)] ts:grid-cols-[repeat(3,_248px)] grid-rows-[repeat(2,_363px)] gap-x-[50px] gap-y-[40px] z-10">
                <div className='flex justify-center'>
                    <div className='rounded-[30px] flex-col w-[248px] h-[363px] [box-shadow:0_5px_10px_0_rgba(30,_149,_155,_0.5)] bg-[linear-gradient(180deg,_#fff_0%,_#f7f9fd_100%)] flex items-center justify-center'>
                        <Image
                            className=""
                ...
                <div className='ts:hidden ns:flex justify-center'>
                    <div className='rounded-[30px] flex-col w-[248px] h-[363px] [box-shadow:0_5px_10px_0_rgba(30,_149,_155,_0.5)] bg-[linear-gradient(180deg,_#fff_0%,_#f7f9fd_100%)] flex items-center justify-center'>
                        <Image
                            className=""
                            src='images/Group190.svg'
            ...
            <div className="bg-[#1e959b] ts:hidden vs:h-[110px] w-full z-0 absolute vs:mt-[0px]"></div>
        </div>
    );
}
